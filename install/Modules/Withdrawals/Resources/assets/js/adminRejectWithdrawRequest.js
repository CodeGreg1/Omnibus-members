...
app.adminRejectWithdrawRequest = {};

app.adminRejectWithdrawRequest.config = {
    button: '#btn-reject-withdraw-request'
};

app.adminRejectWithdrawRequest.ajax = function() {
    const self = this;
...
app.adminRejectWithdrawRequest.init = function() {
    this.ajax();
};

$(document).ready(app.adminRejectWithdrawRequest.init());
