...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\System\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\System\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(module_path('System', '/Routes/admin.php'));
    }
