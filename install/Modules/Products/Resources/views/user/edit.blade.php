    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-xm-12">
            <div class="card card-form">
                ...
                <form id="user-products-edit-form" method="post" data-action="{{ route('user.products.update', $products->id) }}">
                    @method('patch')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="currency_id_id" class="form-control select2" required>
                                        ...
                                        @foreach($currencyIds as $id => $entry)
                                            <option value="{{ $id }}" {{ $products->currency_id_id == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
