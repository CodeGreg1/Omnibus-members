        ...
        (r.style.maxWidth = t.width),
            b(this.settings.plyr.js, "Plyr", function () {
                ...
                f.on("ready", function (e) {
                    ...
                    f.on("enterfullscreen", B),
                    f.on("exitfullscreen", B);
            });
    }
    function B(e) {
                ...
                n(e, [
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                if ("external" !== o)
                                    return "inline" === o
                                        ? (H.apply(this.instance, [t, s, this.index, v]),
                                          void (s.draggable && new D({ dragEl: t.querySelector(".gslide-inline"), toleranceX: n.dragToleranceX, toleranceY: n.dragToleranceY, slide: t, instance: this.instance })))
                                        : void ("image" !== o
                                              ? w(v) && v()
                                              : (function (e, t, i, n) {
                                                    var s = e.querySelector(".gslide-media"),
                                                    ...
                                                    s.draggable && new D({ dragEl: i, toleranceX: n.dragToleranceX, toleranceY: n.dragToleranceY, slide: t, instance: e.instance }),
                                                        s.zoomable &&
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.trigger("slide_inserted", { index: t, slide: a, slideNode: a, slideConfig: n, slideIndex: t, trigger: null, player: h }),
                                w(this.settings.slideInserted) && this.settings.slideInserted({ index: t, slide: a, player: h });
                        },
                    },
                    {
                        key: "removeSlide",
