    ...
    <div class="d-flex align-items-center justify-content-between mt-4 mt-lg-0">
        <div class="btn-group ml-lg-2 mr-3">
            <button
                ...
                data-toggle="modal"
                data-target="#create-tax-rate-modal"
            >
...
@section('content')
    ...
    <div id="admin-tax-rates-datatable"></div>
@endsection

@section('modals')
    @include('carts::admin.modals.create-tax-rate')
    @include('carts::admin.modals.edit-tax-rate')
@endsection
