...
class UpdateManualGatewayRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if ($this->get('charge_type') === 'fixed') {
            ...
            if ($currency && !$currency->decimal_digits) {
    ...
    {
        return Gate::allows('admin.manual-gateways.update');
    }
}
