...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\Wallet\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\Wallet\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group([
                module_path('Wallet', '/Routes/web.php'),
                module_path('Wallet', '/Routes/admin.php'),
                module_path('Wallet', '/Routes/user.php')
            ]);
    }
