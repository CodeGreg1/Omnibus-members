<div class="modal fade page-section-details-modal" tabindex="-1" role="dialog" id="admin-page-hero-section-details-edit-modal" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
        <div class="modal-content modal-form">
            ...
            <div class="modal-body">
                <form id="admin-page-hero-section-details-edit-form">
                    ...
                    <div class="display-none section-background-image-wrapper">
                        <div class="form-group">
                            ...
                            <div data-image-gallery="1111"></div>
                        </div>
                    </div>
