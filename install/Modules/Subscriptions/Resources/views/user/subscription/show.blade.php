        ...
        @if (!$subscription->canceled() && $subscription->valid() && !$subscription->ended())
            <div class="btn-group ml-2 mr-3">
                @can('user.subscriptions.cancel')
                    <a href="javascript:void(0)" class="btn btn-danger btn-cancel-user-subscription" data-id="{{ $subscription->id }}">
                ...
                <div class="profile-widget-header">
                    ...
                    <div class="profile-widget-items">
                        <div class="profile-widget-item">
                            ...
                            <div class="profile-widget-item-value email text-muted">{{ $subscription->subscribable->email }}</div>
