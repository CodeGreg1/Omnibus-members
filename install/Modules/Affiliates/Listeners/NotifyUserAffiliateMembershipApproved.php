...
class NotifyUserAffiliateMembershipApproved
{
    public $mailer;
    ...
    {
        if (setting('notify_user_affiliate_membership_approved') === 'enable') {
            try {
                $this->mailer->template(AffiliateEmailType::AFFILIATE_MEMBERSHIP_APPROVED)
