...
<link media="all" type="text/css" rel="stylesheet" href="{{ url('css/site/base.min.css') }}">
{!! theme_style('css/theme.min.css') !!}
...
@if(setting('frontend_custom_css'))
	<style>
	    {!! setting('frontend_custom_css') !!}
	</style>
@endif
<!-- End Site Styles Section -->