...
use Modules\Blogs\Services\BlogPageSection;
use Modules\Pages\Services\PageSectionBuilder;
use Modules\Blogs\Services\BlogPageSectionValidator;
    ...
    protected function registerPageBuilderSections()
    {
        PageBuilder::sections([
            new PageSectionBuilder(...[
                __('Blog'),
                'blog',
                '/upload/media/icon/blog.svg',
                true,
                BlogPageSection::class,
                [
                    BlogPageSectionValidator::class
                ]
            ])
        ]);
    }
