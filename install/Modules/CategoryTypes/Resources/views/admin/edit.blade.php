    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-xm-12">
            <div class="card card-form">
                ...
                <form id="admin-category-types-edit-form" method="post" data-action="{{ route('admin.category-types.update', $categorytypes->id) }}">
                    @method('patch')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control select2">
                                        ...
                                        @foreach(Modules\CategoryTypes\Models\CategoryType::TYPE_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ $categorytypes->type == $label ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group mb-0">
                                    ...
                                    <textarea name="description"
                                        class="form-control">{{ $categorytypes->description }}</textarea>
                                </div>
                            </div>
