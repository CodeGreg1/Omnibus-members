            ...
            <div class="card card-form">
                ...
                <div class="card-body p-20">
                    ...
                    @include('tickets::partials.convo-list', [
                        'removeMediaRoute' => 'user.tickets.remove-media'
                    ])

                    <p class="text-center"><a href="{{ route('user.tickets.index') }}" class="btn btn-default btn-lg"><i class="fas fa-arrow-left"></i> @lang('Back to list')</a></p>
                </div>
...
@section('modals')
    ...
    @include('tickets::partials.modals.edit-subject', ['editSubjectRoute' => 'user.tickets.update-subject'])
@endsection