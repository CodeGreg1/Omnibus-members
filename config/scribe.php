...
return [
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'Their is 2 options accessing endpoints:<br><br>Option 1 is to login via API so that it will generate api token and the developer will store it in a safe storage and retrieve it once needed to access the API.<br><br> Option 2 you can retrieve your token by visiting your dashboard under profile menu there is <b>Personal Access Tokens</b> then click it then create new token there.',
    ],
