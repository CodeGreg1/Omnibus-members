...
|
*/
Route::group(['prefix' => 'admin/tickets', 'as' => 'admin.', 'namespace' => 'Admin'], function()
{   
    Route::group(['middleware' => ['auth', 'verified', 'can:admin.tickets.index']], function() {
        ...
        Route::post('/status/{id}/change', 'TicketsController@statusChange')->name('tickets.status-change');
