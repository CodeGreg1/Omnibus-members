...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\Products\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\Products\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(module_path('Products', '/Routes/admin.php'));
            
        Route::middleware('web')
            ->namespace($this->moduleWebNamespace)
            ->group(module_path('Products', '/Routes/user.php'));
