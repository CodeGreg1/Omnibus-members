...
app.invoiceReceiptSend.config = {
    button: '#btn-send-invoice-receipt'
};

app.invoiceReceiptSend.process = function(e) {
...
app.invoiceReceiptSend.init = function() {
    $(this.config.button).on('click', this.process.bind());
};

$(document).ready(app.invoiceReceiptSend.init());
