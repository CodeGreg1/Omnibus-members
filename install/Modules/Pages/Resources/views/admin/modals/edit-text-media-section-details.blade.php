<div class="modal fade page-section-details-modal" tabindex="-1" role="dialog" id="admin-page-text-media-section-details-edit-modal" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
        <div class="modal-content modal-form">
            ...
            <div class="modal-body">
                <form id="admin-page-text-media-section-details-edit-form">
