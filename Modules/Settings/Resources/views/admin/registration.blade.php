        ...
        <div class="col-lg-9 col-md-9 col-xm-12">
            <div class="card card-form">
                ...
                <form id="admin-settings-edit-form" method="post">
                    @method('patch')
                    <input type="hidden" name="redirect" value="/admin/settings/registration">
                    <div class="card-body">
                        
                        @include('settings::admin.partials.registration.general')

                        @include('settings::admin.partials.registration.api')
