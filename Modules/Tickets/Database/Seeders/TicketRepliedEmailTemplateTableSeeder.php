...
class TicketRepliedEmailTemplateTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        EmailTemplate::create([
            'name' => TICKET_REPLIED_EMAIL_TEMPLATE,
            'subject' => 'Ticket Comment from {first_name} {last_name} [Ticket #{ticket_number}]',
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">There is a new comment on the support ticket in the {ticket_category} category from {first_name} {last_name}. Here\'s what they said:</p>
<blockquote style="border-left: 2px solid #ddd; padding-left: 10px;">
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">{ticket_reply}</p>
</blockquote>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Do not reply to this email!</p>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><a title="Click here to sign in and reply to this ticket." href="{ticket_url}" target="_blank" rel="noopener">Click here to sign in and reply to this ticket.</a></p>
</td>
</tr>
</tbody>
</table>
