    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-xm-12">
            <div class="card card-form">
                ...
                <form id="user-tickets-create-form" method="post">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="priority" class="form-control select2" required>
                                        ...
                                        @foreach(Modules\Tickets\Support\TicketPriority::lists() as $key => $priority)
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message"
                                        id="message"
                                        class="form-control user-tickets-tinymce-default"></textarea>
                                </div>
                            </div>
