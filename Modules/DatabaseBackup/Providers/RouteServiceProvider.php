...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\DatabaseBackup\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\DatabaseBackup\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(module_path('DatabaseBackup', '/Routes/admin.php'));
    }
