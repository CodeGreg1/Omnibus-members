...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\EmailTemplates\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\EmailTemplates\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(module_path('EmailTemplates', '/Routes/web.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::prefix('api')
            ...
            ->group(module_path('EmailTemplates', '/Routes/api.php'));
    }
}
