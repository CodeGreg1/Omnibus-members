    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-xm-12">
            <div class="card card-form">
                ...
                <form id="admin-tickets-edit-form" method="post" data-action="{{ route('admin.tickets.update', $tickets->id) }}">
                    @method('patch')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control select2">
                                        ...
                                        @foreach($categories as $id => $entry)
                                            <option value="{{ $id }}" {{ $tickets->category_id == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message"
                                        id="message"
                                        class="form-control admin-tickets-tinymce-default">{{ $tickets->message }}</textarea>
                                </div>
                            </div>
                                            ...
                                            <li class="list-group-item px-0">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        class="remove-dropzone-file action-item delete-item" data-dz-id="#admin-tickets-attachments-dropzone" data-id="{{ $entry->uuid }}"
                                                        data-route="{{ route('admin.tickets.remove-media') }}">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                </div>
