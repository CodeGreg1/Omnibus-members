...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\Orders\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\Orders\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group([
                module_path('Orders', '/Routes/web.php'),
                module_path('Orders', '/Routes/user.php'),
                module_path('Orders', '/Routes/admin.php')
            ]);
    }
