...
class TicketStatusChangedAutomaticallyEmailTemplateTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        EmailTemplate::create([
            'name' => TICKET_STATUS_CHANGED_AUTOMATICALLY_EMAIL_TEMPLATE,
            'subject' => 'Ticket Change Status Automatically to {ticket_status} [Ticket #{ticket_number}]',
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Status changed automatically to <strong>{ticket_status}</strong> on the support ticket in the <strong>{ticket_category}</strong> category. As we have not received a response from you in over {ticket_hours_before_auto_closed} hours.</p>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">If you have any further questions then please just reply to re-open the ticket.</p>
