...
class SocialLinkSettingController extends BaseController
{
    ...
    {
        return view('frontend::admin.social-links', [
            'pageTitle' => __('Social links settings')
        ]);
    }
    ...
    public function update(Request $request)
    {
        ...
        event(new SettingsUpdated('frontend social links settings'));
