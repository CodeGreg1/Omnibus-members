...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\Cashier\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\Cashier\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(
                [
                    module_path('Cashier', '/Routes/web.php'),
                    module_path('Cashier', '/Routes/admin.php')
                ]
            );
    }
