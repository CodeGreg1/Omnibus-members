...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleWebNamespace = 'Modules\Tickets\Http\Controllers\Web';
     ...
     * @var string
     */
    protected $moduleApiNamespace = 'Modules\Tickets\Http\Controllers\Api';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(module_path('Tickets', '/Routes/admin.php'));
            
        Route::middleware('web')
            ->namespace($this->moduleWebNamespace)
            ->group(module_path('Tickets', '/Routes/user.php'));
