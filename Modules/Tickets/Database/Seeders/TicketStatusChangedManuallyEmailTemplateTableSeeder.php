...
class TicketStatusChangedManuallyEmailTemplateTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        EmailTemplate::create([
            'name' => TICKET_STATUS_CHANGED_MANUALLY_EMAIL_TEMPLATE,
            'subject' => 'Ticket Change Status Manually to {ticket_status} from {first_name} {last_name} [Ticket #{ticket_number}]',
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Status changed manually to <strong>{ticket_status}</strong> on the support ticket in the <strong>{ticket_category}</strong> category from <em>{first_name} {last_name}</em>.</p>
